...
#if !defined(MCU_MK60D10) && !defined(MCU_MK60N512VMD100)  /* Check if memory map has not been already included */
#define MCU_MK60D10
...
typedef struct MCG_MemMap {
  ...
  uint8_t SC;                                     /**< MCG Auto Trim Control Register, offset: 0x8 */
...
typedef struct MCM_MemMap {
  ...
  uint32_t CR;                                 /**< SRAM arbitration and protection, offset: 0xC */
...
typedef struct RNG_MemMap {
  uint32_t CR;                                    /**< RNGB Version ID Register, offset: 0x0 */
  uint32_t SR;                                    /**< RNGB Command Register, offset: 0x4 */
  uint32_t ER;                                     /**< RNGB Control Register, offset: 0x8 */
  uint32_t OR;                                     /**< RNGB Status Register, offset: 0xC */
...
typedef struct TSI_MemMap {
  ...
  uint32_t WUCNTR;                                 /**< Status Register, offset: 0xC */
  uint8_t RESERVED_0[240];
  ...
  uint32_t THRESHLD;                           /**< Channel n threshold register, array offset: 0x120, array step: 0x4 */
...
#else /* #if !defined(MCU_MK60D10) && !defined(MCU_MK60N512VMD100) */
...
#endif  /* #if !defined(MCU_MK60D10) && !defined(MCU_MK60N512VMD100) */
